        ...
        <section>
            <Container className="pt-[75px]">
                ...
                <div className="flex gap-[12px] mt-[34px]">
                    <div className="flex-[793] bg-[url(/tech-bg.jpg)] bg-no-repeat bg-center bg-cover w-full rounded-[8px]"></div>
                    ...
                    <div className="flex flex-col gap-[20px] flex-[563] bg-gradient-1 rounded-[8px] bg-custom-gradient border border-[var(--accent-1)] p-[20px]">
                        <p className="text-[24px] text-balance">
                            ...
                            <span className="font-medium">mrnet</span>. Наш мультироутер суммирует несколько каналов
                            связи в один (технология бондинг), значительно повышая устойчивость и скорость соединения!
                        </p>
